...
const COURSE_DATA: Record<string, any[]> = {
  ...
  "java exceptions & algorithms": [
    ...
    { topic: "File Handling using Character Streams", videos: [{ title: "File Handling using Character Streams", url: "https://d1sq67t1c2pewz.cloudfront.net/Staging/ScromPackages/java_exception_algorithms/FILE+HANDLING+USING+BYTE+STREAMS/index_lms.html" }] },
  ...
  "spring boot": [
    ...
    { topic: "Spring Boot with JSON Web Token (JWT)", videos: [{ title: "Spring Boot with JSON Web Token (JWT)", url: "https://d1sq67t1c2pewz.cloudfront.net/Staging/ScromPackages/springboot/Spring+Boot+with+JSON+Web+Token+(JWT)%C2%A0/index_lms.html" }] },
